...
console.log('task 1b:', createMenuItem('lasagna', 7, 'dinner'));
console.log('task 1b:', createMenuItem('toast', 3, 'breakfast'));
...
function addReview(array, string1, number, string2){
  array.push({name: string1, rating: number, feedback: string2});
  return array;
}
